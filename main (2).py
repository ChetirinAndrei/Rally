...
sound_car_accident = pg.mixer.Sound('Image/archive/udar.wav')
sound_canister = pg.mixer.Sound('Image/archive/canister.wav')
font = pg.font.Font(None, 32)
button_start = pg.image.load('Image/archive/start_button.png')
button_start_rect = button_start.get_rect(center=(WIDTH // 2, HEIGHT // 2 - 100))
button_stop = pg.image.load('Image/archive/stop_button.png')
button_stop_rect = button_stop.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 100))

fuel_image = pg.image.load('Image/archive/fuel.png')
canister_image = pg.image.load('Image/archive/canister.png')
water_image = pg.image.load('Image/archive/water.png')
...
def screen1(record):
    ...
    screen.blit(sc, (0, 0))
    screen.blit(font.render(f'Record: {record}', 1, GREEN), (10, 10))
